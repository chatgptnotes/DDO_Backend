...
from core.patient_views import (
    ...
    PatientMedicalConditionDeleteView,
    PatientMedicationCreateView,
    PatientMedicationDeleteView,
    PatientRegisterView,
...
urlpatterns = [
    ...
    path("api/patients/me/medical-conditions/<uuid:item_id>/", PatientMedicalConditionDeleteView.as_view(), name="patient_medical_condition_delete"),
    path("api/patients/me/allergies/", PatientAllergyCreateView.as_view(), name="patient_allergies"),
    path("api/patients/me/allergies/<uuid:item_id>/", PatientAllergyDeleteView.as_view(), name="patient_allergy_delete"),
    path("api/patients/me/medications/", PatientMedicationCreateView.as_view(), name="patient_medications"),
